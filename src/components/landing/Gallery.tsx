...
export function Gallery() {
  const portfolioItems = [
    ...
    { type: 'image', src: 'https://images.unsplash.com/photo-1620882674384-5f569f62660d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80', span: 'col-span-1 md:col-span-2 row-span-1' },
  ];
