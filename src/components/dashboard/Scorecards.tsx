...
export function Scorecards() {
  const cards = [
    { title: "Receita Total (Mês)", value: "R$ 45.850", icon: <DollarSign className="w-8 h-8 text-green-500" />, trend: "+12.5%", color: "text-green-400", bg: "bg-green-400/10" },
    { title: "Lucro Estimado", value: "R$ 28.300", icon: <TrendingUp className="w-8 h-8 text-blue-500" />, trend: "+8.2%", color: "text-blue-400", bg: "bg-blue-400/10" },
    { title: "Agendamentos (Hoje)", value: "14", icon: <CalendarCheck className="w-8 h-8 text-purple-500" />, trend: "+3", color: "text-purple-400", bg: "bg-purple-400/10" }
  ];
